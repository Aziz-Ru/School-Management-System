...
import DeleteTeacherForm from "@/components/teacher/DeleteTeacherForm";
...
const TeacherPage = async ({
  ...
  const { teacher, schedules, attendance, notices, status } =
    await get_teacher_info(uid);
    ...
    <div className="flex flex-col xl:flex-row">
      ...
      <div className="w-full xl:w-1/3">
        <div className="mt-1 p-2">
          <h2 className="font-bold text-2xl ">Optional</h2>

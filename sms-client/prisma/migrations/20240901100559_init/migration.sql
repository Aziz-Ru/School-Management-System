...
-- AddForeignKey
ALTER TABLE `course` ADD CONSTRAINT `course_classId_fkey` FOREIGN KEY (`classId`) REFERENCES `classRoom`(`classId`) ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `section` ADD CONSTRAINT `section_classId_fkey` FOREIGN KEY (`classId`) REFERENCES `classRoom`(`classId`) ON DELETE CASCADE ON UPDATE CASCADE;
